...
export default function Form({
    ...
    const currentUrl = () => {
        const urls = [
            'https://www.xn--80aimkbegibhlk6a3ixb.xn--p1ai/',
            ' https://www.xn--80aimkbegibhlk6a3ixb.xn--p1ai/#/',
            ' https://xn--80aimkbegibhlk6a3ixb.xn--p1ai/',
            ' https://xn--80aimkbegibhlk6a3ixb.xn--p1ai/#/',
        ];
    ...
    if (!successSend) {
        return (
            ...
            >
                ...
                <div className={'space-y-2'}>
                    ...
                    <p
                        className={
                            'text-[#8F9DB2]/70 font-regular text-base md:text-2xl leading-tight tracking-[2%]'
                        }
                    >
                        Заполните форму обратной связи и c Вами свяжется специалист нашей компании.
                    </p>
                </div>
                ...
                <div className={'flex flex-col w-full md:gap-x-10 md:gap-y-3'}>
                    <div className={'flex flex-col w-full'}>
                        <label
                            htmlFor={'firstName'}
                            className={
                                'text-base tracking-wider font-medium text-[#2F2E33] px-1 pt-2 pb-1'
                            }
                        >
                        ...
                        <input
                            ...
                            className={
                                'invalid:[&:not(:placeholder-shown):not(:focus)]:border-red-600 invalid:[&:not(:placeholder-shown):not(:focus)]:bg-red-600/10 px-4 w-full py-3 md:p-4 border border-[#717990] focus:bg-[#DFE6F6] hover:bg-[#DFE6F6] outline-none focus:border-base-zinc hover:border-base-zinc text-base tracking-wide'
                            }
                            id={'firstName'}
                        />
                    </div>
                    <div className={'flex flex-col md:flex-row gap-x-3'}>
                        <div className={'flex flex-col w-full'}>
                            ...
                            <PatternFormat
                                ...
                                onChange={handleOnChange}
                                className={
                                    'px-4 w-full py-3 md:p-4 border border-[#717990] focus:bg-[#DFE6F6] hover:bg-[#DFE6F6] outline-none focus:border-base-zinc hover:border-base-zinc text-base tracking-wide'
                                }
                                value={dataForm.tel}
                            />
                        </div>
        ...
        return (
            <div
                className={`relative group min-w-[280px] ${currentUrl() ? 'max-w-[620px]' : 'max-w-[840px]'} gap-3 md:gap-6 flex flex-col justify-start items-start w-full h-fit px-2 pt-5 pb-4 md:px-[60px] md:pb-[60px] md:pt-10 bg-white`}
            >
                {closeForm && (
                    <svg
                        xmlns='http://www.w3.org/2000/svg'
