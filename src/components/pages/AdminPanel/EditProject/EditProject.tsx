    ...
    return (
        <div className={'flex flex-wrap justify-center items-center gap-x-11 gap-y-8 px-2 py-20'}>
            {sortByDateCard(dataCard).map(item => (
                <div key={uuidv4()} className={'flex flex-col'}>
                    ...
                    <div className={'mt-5 flex flex-row gap-4 w-full'}>
                        ...
                        <button
                            className={'w-full bg-red-500 p-3 hover:bg-red-600'}
                            onClick={() => {
                                setDeleteId(item.id);
                        ...
                        <button
                            className={'w-full bg-blue-400 p-3 hover:bg-blue-600'}
                            onClick={() => {
            ...
            {visibleModal && (
                <div
                    className={
                        'fixed top-0 w-screen h-screen bg-gray-700/40 backdrop-blur-sm z-50 flex justify-center items-center'
                    }
                >
                    <div className={'bg-gray-700 p-10 space-y-10'}>
                        ...
                        <div className={'flex flex-row text-center gap-5'}>
                            <a
                                className={
                                    'w-full bg-gray-400 hover:bg-gray-500 p-3 cursor-pointer'
                                }
                            ...
                            <a
                                className={'w-full bg-red-500 p-3 hover:bg-red-600 cursor-pointer'}
                                onClick={() => {
                                    deleteCard(deleteId);
                                    setVisibleModal(!visibleModal);
                                }}
            ...
            {editModal?.open && (
                <div
                    className={
                        'fixed top-0 w-screen bg-gray-700/40 backdrop-blur-sm z-50 flex justify-center items-center'
                    }
                >
